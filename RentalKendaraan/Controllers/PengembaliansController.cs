...
namespace RentalKendaraan.Controllers
{
    public class PengembaliansController : Controller
    {
        ...
        public async Task<IActionResult> Index(string ktsd, string searchString, string currentFilter, int? pageNumber, string sortOrder)
        {
            ...
            var ktsdQuery = from d in _context.Pengembalian orderby d.IdKondisiNavigation.NamaKondisi select d.IdKondisiNavigation.NamaKondisi;
            ...
            switch (sortOrder)
            {
                ...
                default: //name ascending
                    menu = menu.OrderBy(s => s.IdKondisiNavigation);
                    break;
            }
